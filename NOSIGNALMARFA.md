...
### Voice & Tone
- **Dry, self-aware wit** — the fiber joke is the template
- **Editorial, not salesy** — describe, don't pitch
- **Unhurried** — long sentences are fine; let it breathe
- **Specific over generic** — "clerestory windows" not "lots of windows"
- Speaks to: artists, creative couples, people who read Kinfolk, parents with small kids who want something that isn't a chain hotel
